...
murano-common
-------------
murano-common is a project that contains shared code between different Murano
components, and serves as something like oslo-incubator, before we can either
migrate our common code to oslo-incubator or completely get rid off.
